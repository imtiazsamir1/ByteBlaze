...
const Hero = () => {
  ...
  <div className="hero-content text-center">
    <div className="max-w-lg">
      <h1 className="text-5xl font-bold">Welcome To {" "}<span className='bg-gradient-to-r from-primary-700 via-blue-500 to-secondary text-transparent bg-clip-text animate-gradient bg-300%'>ByteBlaze</span></h1>
      <p className="py-6">
        ByteBlaze is the bridge between the complex world of technolgy and the curious eager to understend it.
      </p>
